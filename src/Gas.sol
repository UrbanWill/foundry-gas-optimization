...
contract GasContract {
    ...
    // REMOVED INIT AS DEFAULT VALUE IS ZERO
    ...
    // REMOVED INIT AS DEFAULT VALUE IS FALSE
    bool public isReady;
    enum PaymentType {
        Unknown,
        BasicPayment,
    ...
    constructor(address[] memory _admins, uint256 _totalSupply) {
        ...
        for (uint256 ii = 0; ii < 5; ii++) {
            ...
            if (tempAdmin == contractOwner) {
                balances[contractOwner] = _totalSupply;
                emit supplyChanged(tempAdmin, _totalSupply);
            }else{
                emit supplyChanged(tempAdmin, 0);
            }
